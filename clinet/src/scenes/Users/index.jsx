  ...
  const Users = () => {
    ...
    const columns = [
      ...
      { field: "updatedAt", headerName: "Updated At", flex: 1, editable: false },
      {
        ...
        renderCell: (params) => (
          <>
        <Button variant="contained" color="primary" startIcon={<EditIcon sx={{ marginLeft:"8px" }}/>} onClick={() => openDialog(params.row)} sx={{ width: 25, margin: "4px 4px" }}>
          
        </Button>
        <Button variant="contained" color="error" startIcon={<DeleteIcon sx={{ marginLeft:"8px" }}/>} onClick={() => handleDeleteUser(params.row.id)} sx={{ width: 50, margin: "4px 4px" }}>
